          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
										...
										<?php foreach($gallery_photos->result() as $gallery_photo)
											{
												...
												<tr>
													...
													<td class="text-center"><?php echo $gallery_photo->created_at ?></td>
													<td class="text-center">
														<a href="javascript:void(0)" data-gallery_photo-id="<?php echo $gallery_photo->gallery_photo_id; ?>" class="text-detail-gallery_photo">Detail</a> |
														<a href="javascript:void(0)" data-gallery_photo-id="<?php echo $gallery_photo->gallery_photo_id; ?>" class="text-edit-gallery_photo">Edit</a> |
														<a href="javascript:void(0)" data-gallery_photo-id="<?php echo $gallery_photo->gallery_photo_id; ?>" class="text-delete-gallery_photo">Delete</a>
													</td>
												</tr>
												<?php
												$i = $i + 1;
              ...
              <div id="box-detail-gallery_photo" class="table-responsive" style="display:none; min-height:500px;">
                <h3>Detail News</h3>
                <table class="table">
                	<tr><td width="200">No gallery_photo</td><td><label id="d_gallery_photo_id"></label></td></tr>
